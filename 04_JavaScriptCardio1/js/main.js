...
const born1500s = inventors.filter((inventor) => inventor.year > 1499 && inventor.year < 1600);
...
const peopleLastName = people.sort((aPerson, bPerson) => {
...
const transport = data.reduce((obj, transName) => {
  if (!obj[transName]) {
    obj[transName] = 0;
  }
  obj[transName]++;
